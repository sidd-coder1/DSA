...
class Stack:
    def __init__(self,stackSize):
        ...
        self.stackSize = stackSize # a variable is used to store the size of the stack
    def isFull(self):
        if len(self.stacklist)==self.stackSize: # a method is used to check if the stack is full or not
            return True
        else:
            return False
    def push(self, value):
...
Stackobj=Stack(size) # it will create an object of the stack class and pass the size of the stack as an argument to the constructor of the stack class
